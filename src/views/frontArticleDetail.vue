<script setup>
import { getArticleDetail } from '@/api/front.js'
...
onMounted(async () => {
  try {
    ...
    console.log('知识文章详情', res)
    articleDetail.value = res.data
  } catch (err){
    console.log('获取知识文章详情失败', err)
  }
  ...
  <div class="articleDetail-container">
    ...
    <div class="content">
      <div class="diary-card">
        ...
        <div class="sub-title">
          <el-tag type="primary" plain class="category-tag">{{ articleDetail.categoryName }}</el-tag>
          <div class="flex-box">
      ...
      <div class="diary-card">
        ...
        <div class="tags-content" v-if="articleDetail.tagArray && articleDetail.tagArray.length">
          ...
          <div class="tags-list">
            <el-tag v-for="tag in articleDetail.tagArray" type="info" effect="light" :key="tag">{{ tag }}</el-tag>
          </div>
        </div>
      </div>
    </div>
